...
everything up to date, UBC's [STAT545] page is an excellent resource.
 ...
 - (Once you've installed R) install packages "[tidyverse]" and "[agricolae]"
...
To install [tidyverse] and [agricolae] to your system, open RStudio and in Console type the following
command after `>`:
...
[Workshop Materials]: https://github.com/luckymehra/IntroR/archive/master.zip
